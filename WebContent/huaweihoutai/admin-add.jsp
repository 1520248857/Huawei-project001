...
<html class="x-admin-sm">
    ...
    <head>
        ...
        <script type="text/javascript" src="/huawei-project/huaweihoutai/lib/layui/layui.js" charset="utf-8"></script>
                ...
                <input type="hidden" name="action" value="add"/>
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-inline">
                          <input type="text" id="username" name="managerName" required="" lay-verify="required"
                  ...
                  <div class="layui-form-item">
                      ...
                      <input class="layui-btn"type="submit" name="btnSubmit" value="提交" />
                  </div>
              </form>
            </div>
        </div>

                               ...
                               <c:forEach items="${managers}" var="list">
                                <tr>
                                  ...
                                  <td class="td-manage">
                                    ...
                                    <a title="编辑"  onclick="xadmin.open('编辑','admin-edit.jsp')" href="/huawei-project/ManagerServlet?action=getManager&managerId=${list.managerId}">
                                      <i class="layui-icon">&#xe642;</i>
                                    </a>
                                    <a title="删除" onclick="member_del(this,'要删除的id')" href="/huawei-project/ManagerServlet?action=delete&managerId=${list.managerId}">
                                      <i class="layui-icon">&#xe640;</i>
                                    </a>
                                  </td>
                                </tr>

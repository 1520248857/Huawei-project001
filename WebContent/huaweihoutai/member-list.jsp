    ...
    <body>
        <div class="x-nav">
          <span class="layui-breadcrumb">
            <a href="/huawei-project/huaweihoutai/index.jsp">首页</a>
            <a href="">演示</a>
            <a>
              <cite>导航元素</cite></a>
          </span>
                            ...
                            <table class="layui-table layui-form">
                                ...
                                <c:forEach items="${users}" var="list">
                                  <tr>
                                    ...
                                    <td>${list.password}</td>
                                    <td class="td-manage">
                                      <a title="编辑"  onclick="xadmin.open('编辑','member-edit.jsp',600,400)" href="">
                                        <i class="layui-icon">&#xe642;</i>
                                      </a>
                                     
                                      <a title="删除" onclick="member_del(this,'要删除的id')" href="/huawei-project/UserServlet?action=delete&userId=${list.userid}">
                                        <i class="layui-icon">&#xe640;</i>
                                      </a>
                                    </td>
                                  </tr>

                                ...
                                <tbody>
                                  <c:forEach items="${orders}" var="list">
                                    <tr>
                                        ...
                                        <td>${list.userId}</td>   
                                        <td class="td-manage">
                                            <a title="查看" onclick="xadmin.open('编辑','order-list.jsp')" href="">
                                                <i class="layui-icon">&#xe63c;</i></a>
                                            <a title="删除" onclick="member_del(this,'要删除的id')" href="/huawei-project/OrderServlet?action=delete&orderId=${list.orderId }">
                                                <i class="layui-icon">&#xe640;</i></a>
                                        </td>
                                    </tr>
                                      </c:forEach>
